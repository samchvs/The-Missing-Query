...
class _CellScreenState extends State<CellScreen> with CaseScreenHelper {
        ...
        builder: (context, constraints) {
          return Stack(
            children: [
              Positioned.fill(
                child: Image.asset(
                  'assets/mystery/Case3/cell_loc.png',
                  fit: BoxFit.fill,
                ),
              ),
              SafeArea(
        ...
        child: SizedBox(
          ...
          child: Stack(
            children: [
              Positioned.fill(
                child: Image.asset(
                  'assets/mystery/Case3/cell_question.png',
                  fit: BoxFit.fill,
                ),
              ),
              Positioned(
  ...
  Widget _buildTableView(BoxConstraints constraints) {
    ...
    return Stack(
      children: [
        Positioned.fill(
          child: Image.asset(
            'assets/mystery/Case3/tower_ping.png',
            fit: BoxFit.fill,
          ),
        ),
        Positioned(
  ...
  Widget _buildQueryView(BoxConstraints constraints) {
    return Stack(
      children: [
        Positioned.fill(
          child: Image.asset('assets/mystery/Case3/cell_query.png', fit: BoxFit.fill),
        ),
        Positioned(
          top: 10,
          right: 20,
