...
class _HuangScreenState extends State<HuangScreen> with CaseScreenHelper {
  ...
  void _submitAnswer() async {
    ...
    if (_isHuangCorrectAnswer(_answerController.text)) {
      ...
      final solveKey = 'case3_huang_solved_$userId';
        ...
        builder: (context, constraints) {
          return Stack(
            children: [
              Positioned.fill(
                child: Image.asset(
                  'assets/mystery/Case3/huang_loc.png',
                  fit: BoxFit.fill,
                ),
              ),
              SafeArea(
        ...
        child: SizedBox(
          ...
          child: Stack(
            children: [
              Positioned.fill(
                child: Image.asset(
                  'assets/mystery/Case3/huang_question.png',
                  fit: BoxFit.fill,
                ),
              ),
              Positioned(
  ...
  Widget _buildTableView(BoxConstraints constraints) {
    ...
    return Stack(
      children: [
        Positioned.fill(
          child: Image.asset(
            'assets/mystery/Case3/contracts.png',
            fit: BoxFit.fill,
          ),
        ),
        Positioned(
  ...
  Widget _buildQueryView(BoxConstraints constraints) {
    return Stack(
      children: [
        Positioned.fill(
          child: Image.asset(
            'assets/mystery/Case3/huang_query.png',
            fit: BoxFit.fill,
          ),
        ),
        Positioned(
