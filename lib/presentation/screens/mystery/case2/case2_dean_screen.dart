...
class _DeanScreenState extends State<DeanScreen> with CaseScreenHelper {
  ...
  bool _isDeanCorrectAnswer(String input) {
    ...
    return normalized == 'MAYA CHEN, 12,500' || normalized == 'MAYA CHEN, 12500';
  }
        ...
        builder: (context, constraints) {
          return Stack(
            children: [
              Positioned.fill(
                child: Image.asset(
                  'assets/mystery/Case2/dean_loc.png',
                  fit: BoxFit.fill,
                ),
              ),
              SafeArea(
        ...
        child: SizedBox(
          ...
          child: Stack(
            children: [
              Positioned.fill(
                child: Image.asset(
                  'assets/mystery/Case2/dean_question.png',
                  fit: BoxFit.fill,
                ),
              ),
              Positioned(
  ...
  Widget _buildTableView(BoxConstraints constraints) {
    ...
    return Stack(
      children: [
        Positioned.fill(
          child: Image.asset('assets/mystery/Case2/ledger.png', fit: BoxFit.fill),
        ),
        Positioned(
          top: 10,
          right: 20,
  ...
  Widget _buildQueryView(BoxConstraints constraints) {
    return Stack(
      children: [
        Positioned.fill(
          child: Image.asset('assets/mystery/Case2/dean_query.png', fit: BoxFit.fill),
        ),
        Positioned(
          top: 10,
          right: 20,
